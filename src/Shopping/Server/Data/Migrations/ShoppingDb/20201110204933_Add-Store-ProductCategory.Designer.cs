...
namespace Shopping.Server.Data.Migrations.ShoppingDb
{
    ...
    [Migration("20201110204933_Add-Store-ProductCategory")]
            ...
            modelBuilder.Entity("Shopping.Shared.Data.StoreProductCategory", b =>
                {
                    ...
                    b.HasKey("ProductCategoryId", "StoreId");
            ...
            modelBuilder.Entity("Shopping.Shared.Data.StoreProductCategory", b =>
                {
                    b.HasOne("Shopping.Shared.Data.ProductCategory", "ProductCategory")
                        .WithOne()
                        .HasForeignKey("Shopping.Shared.Data.StoreProductCategory", "ProductCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shopping.Shared.Data.Store", "Store")
                        .WithOne()
                        .HasForeignKey("Shopping.Shared.Data.StoreProductCategory", "StoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
